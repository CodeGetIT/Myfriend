package com.cgit.myfriend.groupVoiceCall.openacall.model;
    ...
    private RtcEngine ensureRtcEngineReadyLock() {
        if (mRtcEngine == null) {
            ...
            try {
                ...
                mRtcEngine = RtcEngine.create(mContext, "dfeec2e8b4fa4a8c9a4287246308d1eb", mEngineEventHandler.mRtcEventHandler);
            } catch (Exception e) {
