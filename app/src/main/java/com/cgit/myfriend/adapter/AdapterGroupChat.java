...
import com.cgit.myfriend.reel.ViewReelActivity;
import com.cgit.myfriend.search.SearchActivity;
import com.cgit.myfriend.story.ChatStoryViewActivity;
import com.cgit.myfriend.story.HighViewActivity;
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()){
                        ...
                        MapboxStaticMap staticImage = MapboxStaticMap.builder()
                                .accessToken("sk.eyJ1IjoiYmlyamVzaC1jb2RlZ2VuIiwiYSI6ImNreGhhczRkdDBiMDkyeHViZTFjdWpkODMifQ.c-Ecsh79AqgjsvHvs6gYxA")
