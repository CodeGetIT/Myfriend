...
import com.cgit.myfriend.model.ModelNotification;
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        holder.itemView.setOnLongClickListener(v -> {
         ...
         builder.setPositiveButton("Delete", (dialog, which) -> {
             ...
             ref.child(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid()).child("Notifications").child(timestamp).removeValue();
