...
import com.cgit.myfriend.podcast.PodcastActivity;
...
public class AdapterPodcast extends RecyclerView.Adapter<AdapterPodcast.MyHolder>{
    ...
    int channelProfile;
    public static final String channelMessage = "com.cgit.myfriend.CHANNEL";
    public static final String profileMessage = "com.cgit.myfriend.PROFILE";
