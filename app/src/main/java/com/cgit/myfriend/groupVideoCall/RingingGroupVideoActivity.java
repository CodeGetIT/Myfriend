package com.cgit.myfriend.groupVideoCall;
...
import com.cgit.myfriend.groupVideoCall.openvcall.ui.VideoGroupCallActivity;
import com.cgit.myfriend.groupVoiceCall.openacall.ui.BaseActivity;
...
public class RingingGroupVideoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.pick).setOnClickListener(v -> {
            ...
            i.putExtra(com.cgit.myfriend.groupVideoCall.openvcall.model.ConstantApp.ACTION_KEY_CHANNEL_NAME, room);
            i.putExtra(com.cgit.myfriend.groupVideoCall.openvcall.model.ConstantApp.ACTION_KEY_ENCRYPTION_KEY, encryption);
