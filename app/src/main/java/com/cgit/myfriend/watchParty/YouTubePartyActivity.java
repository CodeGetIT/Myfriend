...
import com.cgit.myfriend.adapter.AdapterPartyChat;
import com.cgit.myfriend.model.ModelPartyChat;
...
public class YouTubePartyActivity extends YouTubeBaseActivity {
    ...
    public static final String YOUR_API_KEY = "AIzaSyDgPaFmXdU_Hfn-91Pc5y69w1XWFvASufo";
    String id;
